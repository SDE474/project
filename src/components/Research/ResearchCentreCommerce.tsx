      ...
      <div className="bg-[#9E1B32] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg opacity-90">
            Advancing business research and economic development
          </p>
        </div>
      </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-8">
            ...
            <div className="space-y-4">
              <div className="border-b border-gray-200 pb-4">
                <h3 className="font-medium text-gray-900">Dr. Anil Kapoor</h3>
                <p className="text-gray-600">Head of Research Centre</p>
              </div>
              <div className="border-b border-gray-200 pb-4">
                <h3 className="font-medium text-gray-900">Dr. Smita Joshi</h3>
                <p className="text-gray-600">Senior Research Fellow</p>
              </div>
              <div className="border-b border-gray-200 pb-4">
                <h3 className="font-medium text-gray-900">Dr. Ravi Kumar</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white rounded-xl shadow-sm p-8">
            ...
            <div className="space-y-4 text-gray-600">
              <p>Our research centre has published in leading commerce journals including:</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Journal of Business Research</li>
                <li>International Commerce Review</li>
                <li>Business Strategy Journal</li>
                <li>Marketing Research Quarterly</li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-8">
            ...
            <div className="space-y-4 text-gray-600">
              <div className="border-l-4 border-[#9E1B32] pl-4 mb-4">
                ...
                <p>For contributions in Marketing Research</p>
              </div>
              <div className="border-l-4 border-[#9E1B32] pl-4 mb-4">
                <h3 className="font-medium text-gray-900">Excellence in Commerce Research</h3>
                <p>Awarded by the Indian Commerce Association</p>
              </div>
            </div>
          </div>
